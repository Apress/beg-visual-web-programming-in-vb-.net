...
#End Region
  ...
  Private Sub btnAccept_Click(ByVal sender As System.Object, _
    ...
    If Page.IsValid Then
      ...
      Else
        Try
          InsertUser()
        Catch ex As DuplicateUsernameException
          lblMessage.Visible = True
          lblMessage.Text = _
            "You are trying to register using a user name that has " + _
            "already been taken by someone else. " + _
  ...
  Private Sub InsertUser()
    Trace.Write("FriendsReunion", _
      "We're entering the InsertUser() method")
    ...
    Catch ex As SqlException
      If ex.Number = 2627 Then
        Throw New DuplicateUsernameException("Can't insert record", ex)
      Else
        doredirect = False
        Me.lblMessage.Visible = True
        Me.lblMessage.Text = "Insert couldn't be performed. "
      End If
    Catch ex As OutOfMemoryException
      doredirect = False
      lblMessage.Visible = True
      lblMessage.Text = "We just run of out memory, " + _
    ...
    If (doredirect) Then Server.Transfer("Login.aspx")
    Trace.Write("FriendsReunion", _
      "We're leaving the InsertUser() method")

  End Sub

  Private Sub UpdateUser()
    Dim values As New ArrayList(10)
    ...
    If doredirect Then Server.Transfer("../Default.aspx")
  End Sub
End Class
